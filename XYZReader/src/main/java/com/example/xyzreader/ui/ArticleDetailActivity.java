...
public class ArticleDetailActivity extends AppCompatActivity
    ...
    private class MyPagerAdapter extends FragmentPagerAdapter implements ArticleDetailFragment.LoadHeadData {
        ...
        public Fragment getItem(int position) {
            mCursor.moveToPosition(position);
            return ArticleDetailFragment.newInstance(mCursor.getLong(ArticleLoader.Query._ID), this);
        }
        ...
        @Override
        public void onLoadHeadData(String title, Spanned subtitle, String photoUrl) {
